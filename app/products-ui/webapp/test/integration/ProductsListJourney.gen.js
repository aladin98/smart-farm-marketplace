...
sap.ui.define([
    ...
    function journey() {
        ...
        //     Then.onTheProductsListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheProductsListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheProductsListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheProductsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheProductsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheProductsListGenerated.onTable(defaultTableId).iPressRow(0);
